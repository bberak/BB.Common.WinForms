...
namespace BB.Common.WinForms
{
    ...
    /// </summary>
    public class ScrollBarExRenderer : IScrollBarRenderer
    {
        #region fields
           ...
           ScrollBarOrientation orientation)
        {
            ...
            //-- Use code below to draw a grip image from a resource file.
        ...
        {
            using (Pen pen = new Pen((enabled ? borderColor : disabledBorderColor)))
            {
