...
namespace BB.Common.WinForms
{
    ...
    public class MetroScrollBar : Control
    {
        ...
        private IScrollBarRenderer Renderer;
        ...
        /// </summary>
        public MetroScrollBar(IScrollBarRenderer renderer)
        {
            Renderer = renderer;
        ...
        public MetroScrollBar()
            :this(new MetroScrollBarRenderer())
        {

        }

        public void ChangeRenderer(IScrollBarRenderer newRenderer)
        {
            Renderer = newRenderer;
        }

        public void BindTo(Control target, Control window)
        {
            Target = target;
            ...
            this.Scroll += new ScrollEventHandler(MetroScrollBar_Scroll);
            Target.SizeChanged += new EventHandler(Target_SizeChanged);
            Window.SizeChanged += new EventHandler(Window_SizeChanged);
        }
        ...
        private void MetroScrollBar_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            {
                //-- This one requires testing...
                Target.Left = -Value + Window.Padding.Left;
            }
        }
        ...
        private void UpdateSettings()
        {
            ...
            if (this.orientation == ScrollBarOrientation.Vertical)
            {
                LargeChange = this.Window.DisplayRectangle.Height / 10;
                SmallChange = this.Window.DisplayRectangle.Height / 20;
                Maximum = this.Target.Height - this.Window.DisplayRectangle.Height;
            }
            else
            {
                //-- This one requires testing...
                LargeChange = this.Window.DisplayRectangle.Width / 10;
                SmallChange = this.Window.DisplayRectangle.Width / 20;
                Maximum = this.Target.Width - this.Window.DisplayRectangle.Width;
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // draw border
            Renderer.DrawBorder(e.Graphics, this.Width - 1, this.Height - 1, this.Enabled);
        }
